...
1. **שלב 1 — תשתית נתונים:** משיגה את רשימת כל המניות, מורידה נתוני
   מסחר יומיים של 60 ימי מסחר אחרונים, מסננת מניות שאינן עומדות בשני
   תנאי הנזילות ביחד — שווי שוק של לפחות מיליארד דולר **וגם** ווליום של
   מעל מיליון מניות ביום המסחר האחרון — ומחשבת אינדיקטורים (SMA20,
   ATR%, CCI14, גאפים פתוחים).
...
1. `שווי שוק >= 1,000,000,000$` — מחושב כ‑Close אחרון × מניות סחירות.
2. `ווליום ביום המסחר האחרון > 1,000,000 מניות` — הנפח של הנר האחרון
   בחלון (השוואה חדה: בדיוק מיליון מניות **נדחה**).
...
```
LOWVOL — FAIL: last-day volume 900,000 not above 1,000,000
SMALLCAP — FAIL: market cap $50,000,000 below $1,000,000,000
BOTHBAD — FAIL: market cap $50,000,000 below $1,000,000,000; last-day volume 900,000 not above 1,000,000
```
